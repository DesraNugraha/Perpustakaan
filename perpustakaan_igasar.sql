...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Apr 2026 pada 09.22
...
CREATE TABLE `transaksi` (
  ...
  `durasi` int(11) NOT NULL COMMENT 'dalam satuan hari',
  `status` enum('pending','dipinjam','ditolak','kembali') NOT NULL DEFAULT 'pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
